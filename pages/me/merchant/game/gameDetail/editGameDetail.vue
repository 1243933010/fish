<template>
	<view>
		...
		<view style="position: fixed;top: 0;width: 100%;z-index: 100;">
			<headers title="编辑活动详情" :leftIcon="true" :rightText="rightText" @rightClick="rightClick"/>
		</view>
		...
		<view class="popup">
			<view class="form">
				...
				<view class="inpp">
					<text>活动内容</text>
					<textarea v-model="val.activity_intro" placeholder="" />
	...
	export default {
		...
		methods:{
			...
			async submit(){
				...
				if(this.val.phone_num.length!==11){
